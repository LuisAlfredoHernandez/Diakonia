<template>
  <div class="grid grid-cols-1 lg:grid-cols-1 place-items-start legacy">
    ...
    <div class="mt-5 grid grid-cols-1 lg:grid-cols-1 place-items-start">
      <pre class="mb-1">Localidad distinta a la suya?</pre>
      <Select
      ...
      <TheCard variant="horizontal">
        <div class="grid grid-cols-2">
          <div class="col1Container">
            ...
            <NavbarLink class="mr-2 list-none italic mt-5"
              >Ver Comentarios
            </NavbarLink>
            <p class="mt-10">Ult vez hace (hr/min): {{ "02:15" }}</p>
            <Button class="mt-5">
              <template #prefix>
                <svg
                  fill="#ffffff"
          ...
          <div class="verificationContainer">
            <div class="flex flex-cols-2 justify-center">
              ...
              <svg
                ...
                width="24px"
                height="24px"
                viewBox="-100.65 -53.65 643.84 643.84"
                xml:space="preserve"
                stroke="#0033ff"
                stroke-width="15.023148000000003"
              >
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g
                  id="SVGRepo_tracerCarrier"
